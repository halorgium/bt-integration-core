...
describe Braintree::QueryResponse do
  ...
  describe "each_transaction" do
    ...
    it "should handle the 0 results case" do
      @response = Braintree::QueryResponse.new(@empty_response)
      n=0
  ...
  describe "error_string" do
    ...
    it "should return string between the error_response tags" do
      @response = Braintree::QueryResponse.new(@error_response)
  ...
  it "should recursively_apply" do
    @response = Braintree::QueryResponse.new(@nested_response)
